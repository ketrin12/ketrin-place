...
<div class="price-card" style="margin-top: -15px;">
    <h3>🌲 Массаж ног</h3>
    <p><b>Что включено:</b>Расслабляющий массаж ног начиная с пяток,заканчивая коленями. Массаж проводится с маслами и мазями для улучшений связок ног.</p>
    <hr style='border-color: #f5ebe6;'>
...
st.divider()
st.caption("© 2026 Ketrin Plase. Режим работы: с 9:00 до 21:00 ежедневно. САЙТ НАХОДИТСЯ В РАЗРОБОТКЕ И НЕ НАХОДИТСЯ В РЕАЛЬНОЙ ЖИЗНИ")
