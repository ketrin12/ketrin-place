...
# ХИТРЫЙ СПОСОБ: Красим весь экран в желтый цвет
st.markdown("""
<style>
...
st.markdown(
    "<div style='background-color: #3d2f2b; padding: 25px; border-radius: 8px; text-align: center; color: white;'>"
    "<h1 style='color: #dfba9d; margin: 0; font-size: 36px;'>Ketrin Plase</h1>"
    "<p style='margin: 8px 0 0 0; color: #d1c2ba; font-size: 16px;'>Услуги • Сертификаты • Галерея • Цены • Контакты</p>"
    "</div>", 
    unsafe_allow_html=True
)
...
with col1:
    st.markdown("<h4 style='color: #bc987e; text-transform: uppercase; letter-spacing: 2px;'>Премиум отдых в Гомеле</h4>", unsafe_allow_html=True)
    ...
    st.markdown("<h3 style='color: #bc987e;'>Скидка -20% на первое посещение!</h3>", unsafe_allow_html=True)
...
# УМНЫЙ ПОИСК: Находим любые картинки в папке images
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
images_folder = os.path.join(BASE_DIR, "images")

img1, img2, img3 = None, None, None

# Если папка существует, берем файлы по порядку
...
<div class="price-card" style="margin-top: -15px;">
    <h3 style='margin-top:0; color: #bc987e;'>🛁 Тайский массаж</h3>
    ...
    <h4 style='color: #3d2f2b; margin-bottom:0;'>Цена: 45 BYN / час</h4>
</div>
""", unsafe_allow_html=True)
...
with p_col2:
    ...
    st.markdown("""
<div class="price-card" style="margin-top: -15px;">
    <h3 style='margin-top:0; color: #bc987e;'>🌲 Массаж ног</h3>
    ...
    <hr style='border-color: #f5ebe6;'>
    <h4 style='color: #3d2f2b; margin-bottom:0;'>Цена: 35 BYN / сеанс</h4>
</div>
""", unsafe_allow_html=True)
...
FORMSPREE_URL = "https://formspree.io/f/xeajwpwl" 
